<?php 
    ...
    if(isset($_POST['update']))  
    {
        ...
        $query = mysqli_query($connect, "UPDATE kategori SET nama_kategori = '$nama' WHERE id_kategori = '$id_kategori'");
        if($query)
        {
            echo "<meta http-equiv='refresh' content='0,url=".BASE_URL."admin/kategori.php'>";
        }
    }
    $query = mysqli_query($connect, "SELECT nama_kategori FROM kategori WHERE id_kategori = '$id_kategori'");
